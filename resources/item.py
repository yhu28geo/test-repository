...
class ItemList(Resource):
    @jwt_optional # Useful if you want to show different information when user logged in / logged out
    def get(self):
        user_id = get_jwt_identity() # Useful to see who the user is that is logged in
